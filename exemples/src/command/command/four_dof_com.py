...
class Algo(rclpy.node.Node):
    ...
    def _cmd_received_callback(self, message):
        ...
        theta_4_degree = np.degrees(theta_4)
        ...
        motors_angles.theta_4 = theta_4_degree
        self.get_logger().info(f"theta_1 = {theta_1_degree}, theta_2 = {theta_2_degree}, theta_3 = {theta_3_degree}, theta_4 = {theta_4_degree} ", once=False)
