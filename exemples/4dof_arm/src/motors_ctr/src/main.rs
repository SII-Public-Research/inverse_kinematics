...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    tokio::task::spawn(async move {
        ...
        subscriber.for_each(|msg| {
            ...
            ms.set_servo_angle(ServoNumber::S2, msg.theta_3 as f32).expect("Error setting motor");
            ms.set_servo_angle(ServoNumber::S3, msg.theta_4 as f32).expect("Error setting motor");
